...
d=1;                    % d is chengxing Brownian paremeter
...
save doublea25x1sta1eps01alph175T10  t x_star u1 u2 uu1 uu2 x
plot(t,x_star,'b*-')
xlabel('t');
ylabel('X_m(t)');
title 'The Maximum likelihood transition path from -2 to 2（original） '
